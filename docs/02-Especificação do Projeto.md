...
| ![Sol](img/Sol.png)         | Sol     | 18    | SP  | Cursos de Scrum               |
...
| ------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ---------- |
| RF-001 | A aplicação deve possibilitar que um usuário, cadastrado ou não, possa realizar pesquisa de material para estudo.                                                                                                                                                                                | ALTA       |
| RF-002 | A aplicação deve oferecer uma funcionalidade de filtro de pesquisa do material de forma específica para usuários cadastrado ou não.                                                                                                                                                              | ALTA       |
...
| RF-005 | A aplicação deve possibilitar que um usuário cadastrado possa incluir e GERENCIAR uma referência de material para consulta, enquanto o status de seu material ainda estiver pendente, contendo pelo menos os seguintes campos: Título do material, área do conhecimento, resumo, link de acesso. | ALTA       |
...
| RF-008 | A aplicação deve notificar o autor do conteúdo por e-mail sobre a aprovação/veto do seu conteúdo.                                                                                                                                                                                                | ALTA       |
| RF-009 | Todo material terá duas etapas: Pendente e confiável/não confiável.                                                                                                                                                                                                                              | ALTA       |
| RF-010 | Somente materiais avaliados como **confiável** poderá ser exibido no campo de pesquisa.                                                                                                                                                                                                          | ALTA       |
